<?php 
 ...
 if (have_comments()) {
 	...
 	<div class="comentario">
 		...
 		<div class="comentario_area">
 			<strong><?php comment_author(); ?> - <?php comment_date(); ?><br>
 				<?php comment_text(); ?>
 			</strong>
 		</div>
 	</div>
 ...
 comment_form(array(
 	...
 	'fields' => array(
 		...
 		'email' => 'E-mail: <input type="email" name="email" placeholder="Digite seu email"><br>',
 		'url' => 'Site: <input type="text" name="url" placeholder="Digite seu site"><br>'
 	),

 	'class_submit' => 'botao',
 	'label_submit' => 'Envie o seu comentário',
